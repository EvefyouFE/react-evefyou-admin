...
export function renderHeader(props: BasicModalProps, innerProps: ModalInnerProps) {
    ...
    function handleTitleDbClick(e: React.MouseEvent<HTMLButtonElement, MouseEvent>) {
...
export function renderClose(props: BasicModalProps, innerProps: ModalInnerProps) {
    const {
        closeIconProps,
        onCancel,
    } = props
...
export function renderFooter(props: BasicModalProps, innerProps: ModalInnerProps) {
    const {
        footerProps = {},
        onCancel,
    } = props
