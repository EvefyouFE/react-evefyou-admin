...
export const CommonContainerContext = React.createContext(
  DEFAULT_COMMON_CONTAINER_VALUE,
);
// eslint-disable-next-line react-refresh/only-export-components
export const useCommonContainerContext = () =>
  React.useContext(CommonContainerContext);

export const CommonContainer = forwardRef<
  CommonContainerInstance,
  PropsWithChildren
>(({ children }, ref) => {
  const { footerHeightWithUnit, calcPageContainerPadding } =
